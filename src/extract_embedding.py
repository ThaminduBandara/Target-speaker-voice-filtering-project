...
# enroll_path = "recordings/enroll.wav"
...
# # Paths
# # ----------------------------
# recordings_dir = "recordings/my_voice_samples"  # folder where your 30 recordings are stored
# embedding_path = "recordings/enroll_embedding.pt"
# os.makedirs(recordings_dir, exist_ok=True)
...
# # Assuming your files are named enroll1.wav, enroll2.wav ... enroll30.wav
# for i in range(1, 31):
#     file_path = os.path.join(recordings_dir, f"enroll{i}.wav")
#     signal, fs = load_audio(file_path)
...
#     # Ensure shape [batch, channels, time]
#     signal = signal.unsqueeze(0)  # batch dimension added
...
# # ----------------------------
# # Average embeddings to get final voice print
# # ----------------------------
# enroll_embedding = torch.mean(torch.stack(embeddings), dim=0)
